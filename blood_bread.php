		 ...
		 <div class="row">
            <div class="col-lg-12 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li><a href="view_requests.php" style='text-decoration:none;'><i class='fa fa-edit'></i> View Requests</a></li>
                    <li><a href="view_camp.php" style='text-decoration:none;'><i class='fa fa-home'></i> View Camps</a></li>
                </ol>
            </div>
        </div>
