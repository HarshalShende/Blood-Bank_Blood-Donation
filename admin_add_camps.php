				...
				<div class="col-sm-9" >
					...
					<?php
						if(isset($_POST["submit"]))
							...
							$sql="
							INSERT INTO camps
							(TITLE, ORG_BY, COUNTRY, STATE, CITY, AREA, PINCODE, DETAILS, CAMP_PIC)
							VALUES
							('{$_POST["TITLE"]}', '{$_POST["ORG_BY"]}', '{$country}', '{$state}', '$cityname', '{$_POST["AREA"]}', '{$_POST["PINCODE"]}', '{$_POST["DETAILS"]}', '{$img}');";
									if($con->query($sql))
										{
											echo '
